...
class FrontendContractTest(unittest.TestCase):
    ...
    def test_hong_kong_timezone_and_deep_links(self):
        ...
        self.assertIn("data-event-body-toggle", app)
        self.assertIn("展開完整內容", app)
    ...
    def test_refreshed_theme_is_loaded_on_every_page(self):
        ...
        self.assertIn('.event-issued{justify-self:end;color:var(--cyan)', theme)
        self.assertIn('.event-valid{grid-column:1/-1', theme)
        self.assertIn('.event-body.is-collapsed', theme)
